...
<script lang="ts" setup>
  ...
  import { FabricRender, FabricObjectWithLayer, fabric } from '@/fabric-fusion/v7/core';
  ...
  const resetCanvasLayers = async (baseLayers: CanvasLayerEnum[] | CanvasLayerEnum = []) => {
     ...
     */
    const layerGenerators: Partial<Record<CanvasLayerEnum, () => Promise<fabric.FabricObject[]>>> =
